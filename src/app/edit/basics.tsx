...
import codeBlocksMarkdown from "@/app/editor/examples/assets/code-blocks.md?raw";
  ...
  return (
    <>
      ...
      <MDXEditor
        ...
        onChange={console.log}
        plugins={[jsxPlugin({ jsxComponentDescriptors })]}
      />
    </>
  );
}
...
export function ThematicBreaks() {
  return (
    <MDXEditor markdown={breakMarkdown} plugins={[thematicBreakPlugin()]} />
  );
}
...
export function Link() {
  return (
    <MDXEditor
      markdown={"some [hello](https://google.com) link"}
      plugins={[linkPlugin()]}
    />
  );
}
